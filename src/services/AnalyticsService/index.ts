...
export class AnalyticsService {
	...
	getAnalyticsReportList(params: string, signal: AbortSignal) {
		return this.httpClient.client.get<IAnalyticReportList>(`${this.namespace}/analytics-backend/reports//reports?page=1&list=10`, {
			signal: signal,
		});
	}
	...
	getAnalyticReport(id: string) {
		return this.httpClient.client.get<IAnalyticReport>(`${this.namespace}/analytics-backend/reports//reports/:id`, {
			urlParams: { id },
		});
	}
	...
	createReport(data: Partial<IAnalyticReport>) {
		return this.httpClient.client.post<IAnalyticReport>(`${this.namespace}/analytics-backend/reports//reports`, data);
	}
	...
	updateReport(id: number, data: Partial<IAnalyticReport>) {
		return this.httpClient.client.patch<IAnalyticReport>(`${this.namespace}/analytics-backend/reports//reports/:id`, data, {
			urlParams: { id },
		});
	}
	...
	deleteReport(id: number) {
		return this.httpClient.client.delete<IAnalyticReport>(`${this.namespace}/analytics-backend/reports//reports/:id`, {
			urlParams: { id },
		});
	}
}
